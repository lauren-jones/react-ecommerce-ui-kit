...
export { ProductCard, type ProductCardProps, type product } from './components/product-card';
export { ProductCounter, type ProductCounterProps } from './components/product-counter';
